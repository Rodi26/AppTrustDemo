...
resource "github_actions_variable" "JFROG_MVN_REPO_VIRTUAL" {
  variable_name = "JFROG_MVN_REPO_VIRTUAL"
  value         = var.JFROG_MVN_REPO_VIRTUAL
  repository    = var.github_repository
}

resource "github_actions_variable" "JFROG_MVN_REPO_SNAPSHOTS" {
  variable_name = "JFROG_MVN_REPO_SNAPSHOTS"
  value         = var.JFROG_MVN_REPO_SNAPSHOTS
  repository    = var.github_repository
}

resource "github_actions_variable" "JFROG_MVN_REPO_RELEASES" {
  variable_name = "JFROG_MVN_REPO_RELEASES"
  value         = var.JFROG_MVN_REPO_RELEASES
  repository    = var.github_repository
}
...
resource "github_actions_secret" "JFROG_CLI_SIGNING_KEY" {
  ...
  plaintext_value = local.jfrog_cli_signing_key
  repository      = var.github_repository
}
